...
(function() {
    ...
    a.prototype.transformPoint = function(a, b) {
        return this.p.x = a - (this.offset.x - window.pageXOffset),
    ...
    a.prototype.start = function(a) {
        ...
        this.startPoint = this.snapToGrid(this.transformPoint(a.clientX, a.clientY)),
    ...
    SVG.extend(SVG.Element, {
        draw: function(b, c, d) {
            b instanceof Event || "string" == typeof b || (c = b,
            b = null);
            var e = this.remember("_paintHandler") || new a(this,b,c || {});
            return b instanceof Event && e.start(b),
            e[b] && e[b](c, d),
            this
        }
    }),
    ...
    SVG.Element.prototype.draw.extend = function(a, b) {
        ...
        for (var d in c) {
            ...
            for (var f in e)
                SVG.Element.prototype.draw.plugins[e[f]] = c[d]
        }
    }
    ,
    ...
    SVG.Element.prototype.draw.extend("rect image", {
        ...
        calc: function(a) {
            ...
            b.height = c.y - b.y,
            this.snapToGrid(b),
            b.width < 1 && (b.x = b.x + b.width,
            b.width = -b.width),
            b.height < 1 && (b.y = b.y + b.height,
            b.height = -b.height),
            this.el.attr(b)
        }
    }),
    SVG.Element.prototype.draw.extend("line polyline polygon", {
        ...
        point: function(a) {
            if (this.el.type.indexOf("poly") > -1) {
                ...
                return c.push(this.snapToGrid([b.x, b.y])),
                this.el.plot(c),
                this.drawCircles(this.el.array().valueOf()),
        ...
        drawCircles: function(a) {
            ...
            this.set.clear();
            var b = this.parent.node.getBoundingClientRect();
            b.x -= this.offset.x - window.pageXOffset,
            b.y -= this.offset.y - window.pageYOffset;
            for (var c = 0; c < a.length; ++c) {
                this.p.x = a[c][0],
                this.p.y = a[c][1];
                var d = this.p.matrixTransform(this.m.inverse());
                this.set.add(this.parent.circle(5).stroke({
                    width: 1
                }).fill("#ccc").center(d.x - b.x, d.y - b.y))
            }
        }
    }),
