import {
  ...
  off,
  on
} from "./chunk-L2PSS2AW.js";
import "./chunk-HKJ2B2AA.js";

// node_modules/@svgdotjs/svg.draw.js/dist/svg.draw.js
...
var _PaintHandler = class _PaintHandler2 {
  constructor(el, event, options) {
    ...
    this.options = {};
    this.set = [];
    for (const i in _PaintHandler2.defaults) {
      this.options[i] = _PaintHandler2.defaults[i];
  ...
  param(key, value) {
    this.options[key] = value === null ? _PaintHandler2.defaults[key] : value;
    this.update();
  }
  // Returns the plugin
  getPlugin() {
    return _PaintHandler2.plugins[this.el.type];
  }
  static extend(name, obj) {
    ...
    for (var shapes in plugins) {
      ...
      for (var i in shapesArr) {
        _PaintHandler2.plugins[shapesArr[i]] = plugins[shapes];
      }
    }
  }
};
...
var PaintHandler = _PaintHandler;
extend(Element, {
...
//# sourceMappingURL=@svgdotjs_svg__draw__js.js.map
