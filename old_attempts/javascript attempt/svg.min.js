...
;!function(t, e) {
    ...
    function r(t, e, i) {
        return null == i ? i = t.height / t.width * e : null == e && (e = t.width / t.height * i),
        {
            width: e,
            height: i
        }
    ...
    function a(t) {
        return t instanceof m.Matrix || (t = new m.Matrix(t)),
        t
    }
    function h(t, e) {
    ...
    function u(t) {
        return t = t.replace(m.regex.whitespace, "").replace(m.regex.matrix, "").split(","),
        o(m.utils.map(t, function(t) {
            return parseFloat(t)
        }))
    }
    function l(t, e) {
    ...
    function f(t) {
        for (var e = t.childNodes.length - 1; e >= 0; e--)
            t.childNodes[e]instanceof SVGElement && f(t.childNodes[e]);
    ...
    var m = this.SVG = function(t) {
        return m.supported ? (t = new m.Doc(t),
        m.parser || m.prepare(t),
        t) : void 0
    }
    ;
    if (m.ns = "http://www.w3.org/2000/svg",
    m.xmlns = "http://www.w3.org/2000/xmlns/",
    m.xlink = "http://www.w3.org/1999/xlink",
    ...
    m.invent = function(t) {
        ...
        t.extend && m.extend(e, t.extend),
        t.construct && m.extend(t.parent || m.Container, t.construct),
        e
    }
    ,
    m.adopt = function(t) {
        if (t.instance)
            return t.instance;
        var i;
        return i = "svg" == t.nodeName ? t.parentNode instanceof SVGElement ? new m.Nested : new m.Doc : "lineairGradient" == t.nodeName ? new m.Gradient("lineair") : "radialGradient" == t.nodeName ? new m.Gradient("radial") : m[e(t.nodeName)] ? new (m[e(t.nodeName)]) : new m.Element(t),
        i.type = t.nodeName,
        i.node = t,
        t.instance = i,
        i instanceof m.Doc && i.namespace().defs(),
        i
    }
    ,
    m.prepare = function(t) {
        var e = document.getElementsByTagName("body")[0]
          , i = (e ? new m.Doc(e) : t.nested()).size(2, 0)
          , n = m.create("path");
    ...
    m.Color = function(t) {
        ...
        this.g = 0,
        this.b = 0,
        "string" == typeof t ? m.regex.isRgb.test(t) ? (e = m.regex.rgb.exec(t.replace(/\s/g, "")),
        this.r = parseInt(e[1]),
        this.g = parseInt(e[2]),
        this.b = parseInt(e[3])) : m.regex.isHex.test(t) && (e = m.regex.hex.exec(i(t)),
    ...
    m.extend(m.Color, {
        ...
        morph: function(t) {
            return this.destination = new m.Color(t),
            this
        },
        at: function(t) {
    ...
    m.Color.test = function(t) {
        return t += "",
        m.regex.isHex.test(t) || m.regex.isRgb.test(t)
    }
    ,
    ...
    ,
    m.PointArray.prototype = new m.Array,
    m.extend(m.PointArray, {
        toString: function() {
            for (var t = 0, e = this.value.length, i = []; e > t; t++)
        ...
        parse: function(t) {
            ...
            Array.isArray(t))
                return t;
            t = this.split(t);
            for (var e, i = 0, n = t.length, r = []; n > i; i++)
                e = t[i].split(","),
        ...
        size: function(t, e) {
            ...
            for (i = this.value.length - 1; i >= 0; i--)
                ...
                this.value[i][1] = (this.value[i][1] - n.y) * e / n.height + n.y;
            return this
        },
        bbox: function() {
            return m.parser.poly.setAttribute("points", this.toString()),
            m.parser.poly.getBBox()
        }
    }),
    ...
    ,
    m.PathArray.prototype = new m.Array,
    m.extend(m.PathArray, {
        toString: function() {
            return c(this.value)
        },
        move: function(t, e) {
        ...
        parse: function(t) {
            ...
            i = f.numberOfItems; i > e; ++e)
                ...
                u = l.pathSegTypeAsLetter,
                d = [u],
                "M" == u || "L" == u || "T" == u ? d.push(l.x, l.y) : "H" == u ? d.push(l.x) : "V" == u ? d.push(l.y) : "C" == u ? d.push(l.x1, l.y1, l.x2, l.y2, l.x, l.y) : "S" == u ? d.push(l.x2, l.y2, l.x, l.y) : "Q" == u ? d.push(l.x1, l.y1, l.x, l.y) : "A" == u && d.push(l.r1, l.r2, l.angle, 0 | l.largeArcFlag, 0 | l.sweepFlag, l.x, l.y),
                t.push(d);
            return t
        },
        bbox: function() {
            return m.parser.path.setAttribute("d", this.toString()),
            m.parser.path.getBBox()
        }
    }),
    m.Number = m.invent({
        create: function(t, e) {
            this.value = 0,
            this.unit = e || "",
            "number" == typeof t ? this.value = isNaN(t) ? 0 : isFinite(t) ? t : 0 > t ? -3.4e38 : 3.4e38 : "string" == typeof t ? (e = t.match(m.regex.unit),
            e && (this.value = parseFloat(e[1]),
            "%" == e[2] ? this.value /= 100 : "s" == e[2] && (this.value *= 1e3),
            this.unit = e[2])) : t instanceof m.Number && (this.value = t.valueOf(),
            this.unit = t.unit)
        },
        extend: {
            toString: function() {
            ...
            morph: function(t) {
                return this.destination = new m.Number(t),
                this
            },
            at: function(t) {
    ...
    m.ViewBox = function(t) {
        ...
        for (n = new m.Number(t.width()),
        r = new m.Number(t.height()); "%" == n.unit; )
            s *= n.value,
            n = new m.Number(u instanceof m.Doc ? u.parent().offsetWidth : u.parent().width()),
            u = u.parent();
        for (; "%" == r.unit; )
            o *= r.value,
            r = new m.Number(l instanceof m.Doc ? l.parent().offsetHeight : l.parent().height()),
            l = l.parent();
        this.x = a.x,
        this.y = a.y,
        this.width = n * s,
    ...
    m.Element = m.invent({
        create: function(t) {
            this._stroke = m.defaults.attrs.stroke,
        ...
        extend: {
            x: function(t) {
                return null != t && (t = new m.Number(t),
                t.value /= this.transform("scaleX")),
                this.attr("x", t)
            },
            y: function(t) {
                return null != t && (t = new m.Number(t),
                t.value /= this.transform("scaleY")),
                this.attr("y", t)
            },
            cx: function(t) {
            ...
            parent: function(t) {
                if (this.node.parentNode) {
                    ...
                    if (t)
                        for (; !(e instanceof t) && e.node.parentNode instanceof SVGElement; )
                            e = m.adopt(e.node.parentNode);
                    return e
                }
            },
            doc: function() {
            ...
            svg: function(t) {
                ...
                if (!(t && this instanceof m.Parent))
                    return e.appendChild(t = document.createElement("svg")),
                    t.appendChild(this.node.cloneNode(!0)),
                    e.innerHTML.replace(/^<svg>/, "").replace(/<\/svg>$/, "");
                e.innerHTML = "<svg>" + t.replace(/\n/, "").replace(/<(\w+)([^<]+?)\/>/g, "<$1$2></$1>") + "</svg>";
                for (var i = 0, n = e.firstChild.childNodes.length; n > i; i++)
                    this.node.appendChild(e.firstChild.childNodes[i]);
                return this
            }
        }
    }),
    m.FX = m.invent({
        ...
        extend: {
            animate: function(t, e, i) {
                ...
                e = t.ease,
                t = t.duration),
                t = "=" == t ? t : null == t ? 1e3 : new m.Number(t).valueOf(),
                e = e || "<>",
                a.at = function(t) {
                    var i;
                    if (t = 0 > t ? 0 : t > 1 ? 1 : t,
                    ...
                    a.destination.plot ? o.plot(a.destination.plot.at(t)) : (a.destination.x ? o.x(a.destination.x.at(t)) : a.destination.cx && o.cx(a.destination.cx.at(t)),
                    a.destination.y ? o.y(a.destination.y.at(t)) : a.destination.cy && o.cy(a.destination.cy.at(t)),
                    a.destination.size && o.size(a.destination.size.width.at(t), a.destination.size.height.at(t))),
                    a.destination.viewbox && o.viewbox(a.destination.viewbox.x.at(t), a.destination.viewbox.y.at(t), a.destination.viewbox.width.at(t), a.destination.viewbox.height.at(t)),
                    a.destination.leading && o.leading(a.destination.leading.at(t)),
                    i = n.length - 1; i >= 0; i--)
                        o.attr(n[i], l(a.attrs[n[i]], t));
                    for (i = r.length - 1; i >= 0; i--)
                        o.style(r[i], l(a.styles[r[i]], t));
                ...
                "number" == typeof t && (this.timeout = setTimeout(function() {
                    ...
                    a.situation.start = n,
                    a.situation.play = !0,
                    a.situation.finish = n + t,
                    a.situation.duration = t,
                    a.situation.ease = e,
                    a.render = function() {
                        if (a.situation.play === !0) {
                            var n = (new Date).getTime()
                              , r = n > a.situation.finish ? 1 : (n - a.situation.start) / t;
                            a.situation.reversing && (r = -r + 1),
                            a.at(r),
                            n > a.situation.finish ? (a.destination.plot && o.plot(new m.PointArray(a.destination.plot.destination).settle()),
                            a.situation.loop === !0 || "number" == typeof a.situation.loop && a.situation.loop > 0 ? (a.situation.reverse && (a.situation.reversing = !a.situation.reversing),
                            "number" == typeof a.situation.loop && ((!a.situation.reverse || a.situation.reversing) && --a.situation.loop,
                            a.situation.reverse || 1 != a.situation.loop || --a.situation.loop),
                            a.animate(t, e, i)) : a.situation.after ? a.situation.after.apply(o, [a]) : a.stop()) : a.animationFrame = requestAnimationFrame(a.render)
                        } else
                            a.animationFrame = requestAnimationFrame(a.render)
                    }
                    ,
                    a.render()
                }, new m.Number(i).valueOf())),
                this
            },
            bbox: function() {
            ...
            attr: function(t, e) {
                if ("object" == typeof t)
                    ...
                    "transform" == t ? (this.attrs[t] && (e = this.attrs[t].destination.multiply(e)),
                    this.attrs[t] = this.target.ctm().morph(e),
                    this.param && (e = this.target.transform("rotation"),
                    this.attrs[t].param = {
            ...
            x: function(t) {
                return this.destination.x = new m.Number(this.target.x()).morph(t),
                this
            },
            y: function(t) {
                return this.destination.y = new m.Number(this.target.y()).morph(t),
                this
            },
            cx: function(t) {
                return this.destination.cx = new m.Number(this.target.cx()).morph(t),
                this
            },
            cy: function(t) {
                return this.destination.cy = new m.Number(this.target.cy()).morph(t),
                this
            },
            move: function(t, e) {
                return this.x(t).y(e)
            ...
            size: function(t, e) {
                if (this.target instanceof m.Text)
            ...
            plot: function(t) {
                return this.destination.plot = t,
                this
            },
            leading: function(t) {
                return this.target.destination.leading && (this.destination.leading = new m.Number(this.target.destination.leading).morph(t)),
                this
            },
            ...
            update: function(t) {
                return this.target instanceof m.Stop && (null != t.opacity && this.attr("stop-opacity", t.opacity),
                null != t.color && this.attr("stop-color", t.color),
                null != t.offset && this.attr("offset", new m.Number(t.offset))),
                this
            },
            during: function(t) {
                return this.situation.during = t,
                this
            },
            after: function(t) {
                return this.situation.after = t,
                this
            },
            loop: function(t, e) {
                return this.situation.loop = this.situation.loops = t || !0,
                this.situation.reverse = !!e,
                this
            },
            stop: function(t) {
                return t === !0 ? (this.animate(0),
                this.situation.after && this.situation.after.apply(this.target, [this])) : (clearTimeout(this.timeout),
    ...
    m.TBox = m.invent({
        create: function(t) {
            if (t) {
                var e = t.ctm().extract()
                  , i = t.bbox();
                this.width = i.width * e.scaleX,
                this.height = i.height * e.scaleY,
                this.x = i.x + e.x,
                this.y = i.y + e.y
            }
            d(this)
    ...
    [m.BBox, m.TBox, m.RBox].forEach(function(t) {
        m.extend(t, {
            merge: function(e) {
                var i = new t;
                return i.x = Math.min(this.x, e.x),
                i.y = Math.min(this.y, e.y),
                i.width = Math.max(this.x + this.width, e.x + e.width) - i.x,
                i.height = Math.max(this.y + this.height, e.y + e.height) - i.y,
                d(i)
            }
        })
    }),
    m.Matrix = m.invent({
        create: function(t) {
            ...
            for (t = t && t.node && t.node.getCTM ? t.node.getCTM() : "string" == typeof t ? u(t) : 6 == arguments.length ? o([].slice.call(arguments)) : "object" == typeof t ? t : i,
            e = g.length - 1; e >= 0; e--)
                this[g[e]] = t && "number" == typeof t[g[e]] ? t[g[e]] : i[g[e]]
        },
        extend: {
            extract: function() {
                var t = s(this, 0, 1)
            ...
            morph: function(t) {
                return this.destination = new m.Matrix(t),
                this
            },
            at: function(t) {
                if (!this.destination)
                ...
                if (this.param && this.param.to) {
                    ...
                    e = e.rotate((this.param.to.rotation - 2 * this.param.from.rotation) * t, i.cx, i.cy),
                    e.param = i
                }
                return e
            },
            ...
            scale: function(t, e, i, n) {
                return (1 == arguments.length || 3 == arguments.length) && (e = t),
                3 == arguments.length && (n = i,
                i = e),
                this.around(i, n, new m.Matrix(t,0,0,e,0,0))
            },
            rotate: function(t, e, i) {
                return t = m.utils.radians(t),
                this.around(e, i, new m.Matrix(Math.cos(t),Math.sin(t),-Math.sin(t),Math.cos(t),0,0))
            },
            flip: function(t, e) {
            ...
            "native": function() {
                for (var t = m.parser.draw.node.createSVGMatrix(), e = g.length - 1; e >= 0; e--)
                    t[g[e]] = this[g[e]];
                return t
            },
            toString: function() {
    ...
    m.extend(m.Element, {
        attr: function(t, e, i) {
            if (null == t) {
                ...
                i = e.length - 1; i >= 0; i--)
                    t[e[i].nodeName] = m.regex.isNumber.test(e[i].nodeValue) ? parseFloat(e[i].nodeValue) : e[i].nodeValue;
                return t
            }
            if ("object" == typeof t)
                for (e in t)
                ...
                if (null == e)
                    ...
                    null == e ? m.defaults.attrs[t] : m.regex.isNumber.test(e) ? parseFloat(e) : e;
                "stroke-width" == t ? this.attr("stroke", parseFloat(e) > 0 ? this._stroke : null) : "stroke" == t && (this._stroke = e),
                ("fill" == t || "stroke" == t) && (m.regex.isImage.test(e) && (e = this.doc().defs().image(e, 0, 0)),
                e instanceof m.Image && (e = this.doc().defs().pattern(0, 0, function() {
                    this.add(e)
                }))),
                "number" == typeof e ? e = new m.Number(e) : m.Color.isColor(e) ? e = new m.Color(e) : Array.isArray(e) ? e = new m.Array(e) : e instanceof m.Matrix && e.param && (this.param = e.param),
    ...
    m.extend(m.Element, m.FX, {
        transform: function(t, e) {
            ...
            if ("object" != typeof t)
                return i = n.ctm().extract(),
                "object" == typeof this.param && (i.rotation = this.param.rotation,
                i.cx = this.param.cx,
                i.cy = this.param.cy),
                "string" == typeof t ? i[t] : i;
            if (i = this instanceof m.FX && this.attrs.transform ? this.attrs.transform : new m.Matrix(n),
            e = !!e || !!t.relative,
            null != t.a)
                i = e ? i.multiply(new m.Matrix(t)) : new m.Matrix(t);
            else if (null != t.rotation)
                h(t, n),
                e && (t.rotation += this.param && null != this.param.rotation ? this.param.rotation : i.extract().rotation),
                this.param = t,
                this instanceof m.Element && (i = e ? n.attr("transform", i + " rotate(" + [t.rotation, t.cx, t.cy].join() + ")").ctm() : i.rotate(t.rotation - i.extract().rotation, t.cx, t.cy));
                ...
                t.flip ? i = i.flip(t.flip, null == t.offset ? n.bbox()["c" + t.flip] : t.offset) : (null != t.x || null != t.y) && (e ? i = i.translate(t.x, t.y) : (null != t.x && (i.e = t.x),
                null != t.y && (i.f = t.y)));
    ...
    m.extend(m.Element, {
        style: function(e, i) {
            ...
            if (arguments.length < 2)
                ...
                this.node.style[t(e)] = null === i || m.regex.isBlank.test(i) ? "" : i;
            return this
        }
    }),
    m.Parent = m.invent({
        ...
        extend: {
            ...
            each: function(t, e) {
                ...
                for (i = 0,
                n = r.length; n > i; i++)
                    r[i]instanceof m.Element && t.apply(r[i], [i, r]),
                    e && r[i]instanceof m.Container && r[i].each(t, e);
                return this
            },
    ...
    m.Container = m.invent({
        ...
        extend: {
            viewbox: function(t) {
                return 0 == arguments.length ? new m.ViewBox(this) : (t = 1 == arguments.length ? [t.x, t.y, t.width, t.height] : [].slice.call(arguments),
                this.attr("viewBox", t))
            }
        }
    }),
    ...
    m.on = function(t, e, i) {
        var n = i.bind(t.instance || t)
          , r = (m.handlerMap.indexOf(t) + 1 || m.handlerMap.push(t)) - 1
          , s = e.split(".")[0]
          , o = e.split(".")[1] || "*";
        m.listeners[r] = m.listeners[r] || {},
        m.listeners[r][s] = m.listeners[r][s] || {},
        m.listeners[r][s][o] = m.listeners[r][s][o] || {},
        m.listeners[r][s][o][i] = n,
        t.addEventListener(s, n, !1)
    }
    ,
    m.off = function(t, e, i) {
        var n = m.handlerMap.indexOf(t)
          , r = e && e.split(".")[0]
          , s = e && e.split(".")[1];
        if (-1 != n)
            if (i)
                m.listeners[n][r] && m.listeners[n][r][s || "*"] && (t.removeEventListener(r, m.listeners[n][r][s || "*"][i], !1),
                delete m.listeners[n][r][s || "*"][i]);
            else if (s) {
                if (m.listeners[n][r] && m.listeners[n][r][s]) {
                    for (i in m.listeners[n][r][s])
                        m.off(t, [r, s].join("."), i);
                    delete m.listeners[n][r][s]
                }
            } else if (r) {
                if (m.listeners[n][r]) {
                    for (namespace in m.listeners[n][r])
                        m.off(t, [r, namespace].join("."));
                    delete m.listeners[n][r]
                }
            } else {
                for (e in m.listeners[n])
                    m.off(t, e);
    ...
    m.extend(m.Element, {
        on: function(t, e) {
            return m.on(this.node, t, e),
            this
        },
        off: function(t, e) {
            return m.off(this.node, t, e),
            this
        },
        fire: function(t, e) {
            return this.node.dispatchEvent(new y(t,{
                detail: e
            })),
            this
        }
    ...
    m.extend(m.Element, {
        ...
        forward: function() {
            ...
            e instanceof m.Doc && e.node.appendChild(e.defs().node),
            this
        },
        backward: function() {
            var t = this.position();
        ...
        front: function() {
            ...
            t instanceof m.Doc && t.node.appendChild(t.defs().node),
            this
        },
        back: function() {
    ...
    m.Mask = m.invent({
        create: function() {
            this.constructor.call(this, m.create("mask")),
            this.targets = []
        },
        inherit: m.Container,
        extend: {
    ...
    m.extend(m.Element, {
        maskWith: function(t) {
            return this.masker = t instanceof m.Mask ? t : this.parent().mask().add(t),
    ...
    m.ClipPath = m.invent({
        create: function() {
            this.constructor.call(this, m.create("clipPath")),
            this.targets = []
        },
        inherit: m.Container,
        extend: {
    ...
    m.extend(m.Element, {
        clipWith: function(t) {
            return this.clipper = t instanceof m.ClipPath ? t : this.parent().clip().add(t),
    ...
    m.Gradient = m.invent({
        create: function(t) {
            this.constructor.call(this, m.create(t + "Gradient")),
            this.type = t
        },
        inherit: m.Container,
        extend: {
    ...
    m.Doc = m.invent({
        create: function(t) {
            t && (t = "string" == typeof t ? document.getElementById(t) : t,
            "svg" == t.nodeName ? this.constructor.call(this, t) : (this.constructor.call(this, m.create("svg")),
        ...
        extend: {
            namespace: function() {
                return this.attr({
                    xmlns: m.ns,
                    version: "1.1"
                }).attr("xmlns:xlink", m.xlink, m.xmlns)
            },
            defs: function() {
                if (!this._defs) {
                    var t;
                    this._defs = (t = this.node.getElementsByTagName("defs")[0]) ? m.adopt(t) : new m.Defs,
    ...
    m.Bare = m.invent({
        create: function(t, e) {
            if (this.constructor.call(this, m.create(t)),
            e)
                for (var i in e.prototype)
                    "function" == typeof e.prototype[i] && (t[i] = e.prototype[i])
        },
        inherit: m.Element,
        extend: {
            words: function(t) {
        ...
        extend: {
            load: function(t) {
                ...
                return i.onload = function() {
                    ...
                    n && 0 == n.width() && 0 == n.height() && n.size(e.width(), e.height()),
    ...
    m.Text = m.invent({
        create: function() {
            this.constructor.call(this, m.create("text")),
            this._leading = new m.Number(1.3),
            this._rebuild = !0,
            this._build = !1,
            this.attr("font-family", m.defaults.attrs["font-family"])
        },
        inherit: m.Shape,
        extend: {
            x: function(t) {
            ...
            leading: function(t) {
                return null == t ? this._leading : (this._leading = new m.Number(t),
                this.rebuild())
            },
            lines: function() {
                for (var t = 0, e = this.node.childNodes.length, i = []; e > t; t++)
                    this.node.childNodes[t]instanceof SVGElement && i.push(m.adopt(this.node.childNodes[t]));
                return new m.Set(i)
            },
            rebuild: function(t) {
                ...
                this._rebuild) {
                    ...
                    this.lines().each(function() {
                        ...
                        this.attr("dy", e._leading * new m.Number(e.attr("font-size"))))
                    }),
                    this.fire("rebuild")
                }
                return this
    ...
    m.extend(m.Text, m.Tspan, {
        ...
        tspan: function(t) {
            ...
            this instanceof m.Text && this.lines().add(i),
            i.text(t)
        },
        clear: function() {
            for (var t = (this.textPath() || this).node; t.hasChildNodes(); )
                t.removeChild(t.lastChild);
            return this instanceof m.Text && (this.content = ""),
            this
        },
        length: function() {
    ...
    m.TextPath = m.invent({
        ...
        construct: {
            path: function(t) {
                for (var e = new m.TextPath, i = this.doc().defs().path(t); this.node.hasChildNodes(); )
                    e.node.appendChild(this.node.firstChild);
                return this.node.appendChild(e.node),
                e.attr("href", "#" + i, m.xlink),
                this
            },
            plot: function(t) {
                var e = this.track();
    ...
    m.Nested = m.invent({
        create: function() {
            this.constructor.call(this, m.create("svg")),
    ...
    m.extend(m.Line, m.Polyline, m.Polygon, m.Path, {
        marker: function(t, e, i, n) {
            ...
            r = r.join("-"),
            t = arguments[1]instanceof m.Marker ? arguments[1] : this.doc().marker(e, i, n),
            this.attr(r, t)
        }
    });
    var x = {
    ...
    ["fill", "stroke"].forEach(function(t) {
        var e, i = {};
        i[t] = function(i) {
            if ("string" == typeof i || m.Color.isRgb(i) || i && "function" == typeof i.fill)
                this.attr(t, i);
            else
                for (e = x[t].length - 1; e >= 0; e--)
                    null != i[x[t][e]] && this.attr(x.prefix(t, x[t][e]), i[x[t][e]]);
            return this
        }
        ,
    ...
    m.Set.inherit = function() {
        var t, e = [];
        for (var t in m.Shape.prototype)
            "function" == typeof m.Shape.prototype[t] && "function" != typeof m.Set.prototype[t] && e.push(t);
        ...
        e = [];
        for (var t in m.FX.prototype)
            "function" == typeof m.FX.prototype[t] && "function" != typeof m.FX.Set.prototype[t] && e.push(t);
        e.forEach(function(t) {
    ...
    return function(t) {
        for (var e = 0, i = ["moz", "webkit"], n = 0; n < i.length && !window.requestAnimationFrame; ++n)
